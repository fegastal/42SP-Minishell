...
// static void			checkset_mode(t_msh_tknz *tknz, char *ptr);
...
// 	if (token == NULL)
// 		return ;
// 	if (tknz->modes.size == 0)
// 		token->type = TKMODE_DEFAULT;
// 	else
// 	{
// 		last_mode = ((t_msh_token *) ft_lst_last(tknz.modes))->type;
// 		if (*ptr == '"')
// 			token->type = TKMODE_STR_DOUBLE;
// 			// Parei aqui
// 	}
// }
